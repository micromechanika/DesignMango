...
const actions = {
  getCallToActionsData ({ commit }) {
    const data = {
      ...
      header: 'Som Header',
      text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. A, adipisci animi corporis debitis deleniti deserunt dolore eligendi error esse fugit ipsa ipsam laborum molestiae natus odit quasi sequi tempora voluptatem!',
      items: [{
